...
})(exports.WhispyBlowDirection || (exports.WhispyBlowDirection = {}));
exports.StadiumTransformation = void 0;
...
})(exports.StadiumTransformation || (exports.StadiumTransformation = {}));
exports.StadiumTransformationEvent = void 0;
...
})(exports.StadiumTransformationEvent || (exports.StadiumTransformationEvent = {}));
...
function handleTargetBreak(frames, frame, targetBreaks) {
    ...
    if (currentFrameNumber === exports.Frames.FIRST) {
        const targets = (_c = (_b = (_a = frames[exports.Frames.FIRST]) === null || _a === void 0 ? void 0 : _a.items) === null || _b === void 0 ? void 0 : _b.filter((item) => item.typeId === TARGET_ITEM_TYPE_ID)) !== null && _c !== void 0 ? _c : [];
...
class SlpParser extends TypedEventEmitter {
    ...
    handleCommand(command, payload) {
        switch (command) {
            ...
            case exports.Command.GECKO_LIST:
                ...
                break;
            case exports.Command.FOD_PLATFORM:
                this._handleStageEvent(payload);
                break;
            case exports.Command.WHISPY:
                this._handleStageEvent(payload);
                break;
            case exports.Command.STADIUM_TRANSFORMATION:
                this._handleStageEvent(payload);
                break;
        }
    }
    ...
    getLatestFrameNumber() {
        var _a;
        return (_a = this.latestFrameIndex) !== null && _a !== void 0 ? _a : exports.Frames.FIRST - 1;
    }
    ...
    getItems() {
        var _a, _b;
        if (((_a = this.settings) === null || _a === void 0 ? void 0 : _a.itemSpawnBehavior) === exports.ItemSpawnType.OFF) {
            return undefined;
        }
    ...
    _handleFrameUpdate(command, payload) {
        ...
        if (settings && (!settings.slpVersion || semver.lte(settings.slpVersion, "2.2.0"))) {
            ...
            if (frame) {
                this.emit(exports.SlpParserEvent.FRAME, frame);
            }
    ...
    switch (command) {
        case exports.Command.GAME_START:
            const getPlayerObject = (playerIndex) => {
                ...
                const nameTagString = iconvCp932.decode(nametagBuf).split("\0").shift();
                ...
                const displayNameString = iconvCp932.decode(displayNameBuf).split("\0").shift();
                ...
                const connectCodeString = iconvCp932.decode(connectCodeBuf).split("\0").shift();
...
exports.SlippiGame = SlippiGameWeb;
...
exports.framedata = framedataUtils;
