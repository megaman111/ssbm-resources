...
import { decode as decode$1 } from 'iconv-cp932';
    ...
    switch (command) {
        case Command.GAME_START:
            const getPlayerObject = (playerIndex) => {
                ...
                const nameTagString = decode$1(nametagBuf).split("\0").shift();
                ...
                const displayNameString = decode$1(displayNameBuf).split("\0").shift();
                ...
                const connectCodeString = decode$1(connectCodeBuf).split("\0").shift();
...
async function maybeLoadReconnectCoreModule() {
    ...
    try {
        ...
        const mod = require("reconnect-core");
        reconnectCoreModule = ((mod === null || mod === void 0 ? void 0 : mod.default) ? mod === null || mod === void 0 ? void 0 : mod.default : mod);
        return reconnectCoreModule;
    }
    catch (error) {
        // Ignore and try ESM
    ...
    loadPromise$1 = dynamicImport$1("reconnect-core")
        .then((m) => ((m === null || m === void 0 ? void 0 : m.default) ? m === null || m === void 0 ? void 0 : m.default : m))
        .catch(() => undefined);
    reconnectCoreModule = await loadPromise$1;
    return reconnectCoreModule;
}
async function loadReconnectCoreModule() {
 ...
 * ```
 */
class ConsoleConnection extends TypedEventEmitter {
    constructor(options) {
        super();
        this.connectionStatus = ConnectionStatus.DISCONNECTED;
        this.connDetails = Object.assign({}, defaultConnectionDetails);
     ...
     */
    getDetails() {
        return Object.assign({}, this.connDetails);
    }
    /**
     ...
     *                to the Wii or relay.
     */
    async connect(ip, port, isRealtime = false, timeout = DEFAULT_CONNECTION_TIMEOUT_MS) {
        this.ipAddress = ip;
        this.port = port;
        this.isRealtime = isRealtime;
        await this._connectOnPort(ip, port, timeout);
    }
    async _connectOnPort(ip, port, timeout) {
        ...
        const connection = reconnect({
            ...
            const handshakeMsgOut = consoleComms.genHandshakeOut(this.connDetails.gameDataCursor, (_a = this.connDetails.clientToken) !== null && _a !== void 0 ? _a : 0, this.isRealtime);
...
// eslint-disable-next-line no-new-func
new Function("s", "return import(s)");
async function maybeLoadEnetModule() {
    if (enetModule) {
        return enetModule;
    }
    if (loadPromise) {
    ...
    try {
        // eslint-disable-next-line @typescript-eslint/no-var-requires, @typescript-eslint/no-require-imports
        const mod = require("enet");
        enetModule = ((mod === null || mod === void 0 ? void 0 : mod.default) ? mod === null || mod === void 0 ? void 0 : mod.default : mod);
        return enetModule;
    }
    catch (error) {
        // Ignore and try ESM
...
class DolphinConnection extends TypedEventEmitter {
    constructor() {
        super();
        this.connectionStatus = ConnectionStatus.DISCONNECTED;
        this.gameCursor = 0;
 ...
 * @extends {Writable}
 */
class SlpFileWriter extends Writable {
    /**
    ...
    _setupListeners() {
        this.processor.on(SlpStreamEvent.RAW, (data) => {
            const { command, payload } = data;
            switch (command) {
